...
//         {/* Steps Grid */}
//         <motion.div
//           className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-y-32"
...
//           <motion.div className="flex py-4 lg:px-16" variants={fadeIn}>
...
//           <motion.div className="relative hidden lg:block" variants={fadeIn}>
